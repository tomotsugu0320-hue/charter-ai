    ...
    <main style={pageStyle}>
      ...
      <SectionCard variant="white">
        ...
        <ul style={listStyle}>
          ...
          <li>個人名、住所、電話番号、メールアドレスなどは公開前に削除・匿名化してください</li>
          <li>第三者が特定される情報は貼らないでください</li>
          <li>他人のLINE、DM、メール、会話ログを、本人の許可なく公開しないでください</li>
          <li>読み取っただけでは投稿されません</li>
          <li>投稿前に必ず内容を確認できます</li>
          <li>AI回答は正解ではなく、議論を始めるための叩き台です</li>
          <li>経済・政策・法律・医療など重要な判断は、一次情報や専門家の確認も使ってください</li>
          <li>問題のある投稿を見つけた場合は通報できます。管理者が確認します</li>
        </ul>
      </SectionCard>

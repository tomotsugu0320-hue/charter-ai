...
賃金・労働生産性・価格転嫁・物価・雇用・人手不足に関する経済政策投稿では、次の点を必ず確認してください。
- 投稿がインフレ局面とデフレ局面を区別しているか。
- 需要不足 / 需要超過を確認しているか。
- 失業率、人手不足、労働需給を考慮しているか。
- フィリップス曲線的な因果順序を踏まえているか。
- ミクロ企業会計として正しい主張を、マクロ政策としてそのまま一般化していないか。
- 生産性向上が雇用拡大に使われる局面か、省人化・人件費削減に使われる局面かを区別しているか。
- 価格転嫁が実質賃金、消費、企業収益に与える影響を考慮しているか。

賃金上昇については、次の因果順序を確認してください。
インフレ・需要増 → 労働需要増 → 人手不足 → 失業率低下 → 労働者の交渉力上昇 → 賃金上昇 → 企業が省力化・設備投資・業務改革・価格転嫁を迫られる → 生産性向上圧力。

デフレ・需要不足下では、次のリスクも確認してください。
需要不足 → 売上期待が弱い → 生産性向上が省人化・人件費削減に使われる → 労働需要低下 → 失業率悪化 → 賃金停滞 → 所得減 → 消費低迷 → デフレ圧力。

「生産性が上がれば賃金が上がる」という主張は、需要環境、労働需給、失業率、価格転嫁、企業の投資行動を確認せずに一般化している場合、前提不足として扱ってください。
ミクロでは正しいが、デフレ・需要不足下のマクロ政策としては危険な主張を、高い論理スコアにしすぎないでください。
「どちらも一理あります」「条件次第です」だけで終わらず、どの条件なら成立し、どの条件なら逆効果になるかを logic_score_reason / logic_break_note に反映してください。

質問投稿 issue_raise / question 系については、通常の主張投稿と同じように「根拠不足」で低評価しすぎないでください。
質問投稿では、問いの立て方、前提不足の明示、論点分解のしやすさ、検証すべき条件が示されているかを評価してください。
...
経済政策投稿を評価する場合、logic_break_note の冒頭に、原則として次の形式で関連理論名を明示してください。
関連理論: 〇〇、〇〇。
〇〇には、以下から該当する理論・視点を1〜3個選んでください。
- IS-LM
- AD-AS
- 乗数効果・クラウディングアウト
- フィリップス曲線
...
- 労働需給
- 供給制約
例: 「関連理論: IS-LM、乗数効果・クラウディングアウト、AD-AS。財政政策と消費税増税が金融緩和の効果をどの経路で弱めたのか、需給ギャップ、インフレ率、長期金利、消費、投資などの検証指標が不足しています。」
経済政策投稿では、関連理論名をできるだけ明示してください。ただし、関係ない理論を無理に並べないでください。理論名を出しているだけで高評価にせず、理論名よりも前提・因果関係・検証指標・反論耐性を重視してください。経済理論上の妥当性と政治的・制度的実現可能性は分けて評価してください。
...
- logic_break_note には主な弱点、改善点、反論余地、経済政策上の注意点を日本語で要約してください。弱点がほぼない場合は簡潔に「大きな論理的弱点は見当たりません」と書いてください。
  経済政策投稿の場合、logic_break_note の冒頭には、原則として次の形式を含めてください。
  関連理論: 〇〇、〇〇。
  〇〇には、IS-LM、AD-AS、乗数効果・クラウディングアウト、フィリップス曲線、リカードの等価定理、有効需要、需給ギャップ、可処分所得、労働需給、供給制約などから、投稿内容に関連するものを1〜3個選んでください。
  その後に、未考慮の前提、因果関係、検証指標、反論リスクを説明してください。関係ない理論名を無理に出さないでください。
      `.trim(),
      input: `
投稿分類: ${postRole}
          ...
          schema: {
            ...
            properties: {
              ...
              logic_break_note: {
                type: "string",
                description:
                  "主な弱点、改善点、反論余地、経済政策上の注意点。経済政策投稿の場合は、冒頭を「関連理論: 〇〇、〇〇。」の形式にして、IS-LM、AD-AS、乗数効果・クラウディングアウト、フィリップス曲線、リカードの等価定理、有効需要、需給ギャップ、可処分所得、労働需給、供給制約などから投稿内容に関連するものを1〜3個明示し、その後に未考慮の前提、因果関係、検証指標、反論リスクを書く。",
              },
            },
            required: [
              "logic_score",

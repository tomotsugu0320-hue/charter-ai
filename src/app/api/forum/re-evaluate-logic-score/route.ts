...
比較主張で核心前提に根拠がない場合、logic_score は原則60点以下にしてください。
...
比較条件が揃っていない比較主張は、logic_score を原則60点以下にしてください。
...
スコア上限の制約:
以下の条件に該当する場合、総合論理スコアは原則60点以下にしてください。

1. 比較主張において、財政規模・効果期間・実施コスト・タイムラグ・副作用のうち2つ以上が比較されていない場合。
2. 主張の核心となる前提に、具体的な根拠・データ・実証が示されていない場合。
3. 「一見論理的に見えるが、比較条件が不整合」と判断した場合。

70点以上を付ける場合は、logic_score_reason の中で「比較条件が十分に揃っている理由」を必ず明記してください。
明記できない場合は70点以上を付けないでください。

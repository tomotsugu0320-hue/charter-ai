...
async function evaluateLogicScore(
  ...
  const res = await fetch("https://api.openai.com/v1/responses", {
    ...
    body: JSON.stringify({
      model: "gpt-4.1-mini",
      instructions: `
AI論理スコアは文章の読みやすさではなく、前提・根拠・因果・経済理論との整合性・反論耐性を見る指標です。

採点レンジ:
- 0〜20点: 主張だけ、感情だけ、命令形だけ、根拠なし。例: 「消費税減税しろ！」「解雇なんてひどい！」
- 20〜40点: 主張はあるが理由が弱い。因果関係がほぼない。
- 40〜60点: 主張と簡単な理由がある。因果はあるが浅い。
- 60〜75点: 前提・理由・因果がある。経済理論との整合性もある程度ある。
- 75〜90点: 前提、因果、景気局面、需給、インセンティブ、反論耐性がある。
- 90点以上: 理論整合性、条件分岐、反論への対応、制度設計、代替案まである。

「かわいそう」「ひどい」「減税しろ」「守るべき」などの表現だけでは高スコアにしないでください。
主張が経済政策として感情的に理解できる場合でも、前提・根拠・因果・景気局面・需給・インセンティブ・反論耐性がなければ低く評価してください。

...
財政規模、効果期間、実施コスト、タイムラグ、対象漏れ、副作用の比較が不足している場合は、その不足をlogic_score_reasonまたはlogic_break_noteに明記してください。
比較条件が揃っていない比較主張は、原則として70点以上にしないでください。特に核心前提の根拠がない場合は、50〜60点台以下を基本にしてください。

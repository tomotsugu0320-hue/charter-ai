...
公開投稿候補の question / ai_answer / premises / reasons / risks は、AI知恵袋のスレッド詳細に表示される初期の起・結・承・転に強く影響します。
そのため、経済・政策カテゴリー、特に賃金・労働生産性・価格転嫁・物価・雇用・人手不足に関する投稿候補では、次の方針でJSONを作ってください。

1. question:
- 人物対立をそのまま問いにしないでください。
- 「どちらが正しいか」だけで終わらせず、親ノード化した問いにしてください。
- 悪い例: 「竹中氏と竹田氏のどちらが正しいか。」
- 良い例: 「賃金上昇は、どの景気局面で、どの経路を通じて起こるのか。」
- 良い例: 「生産性向上は賃金上昇の原因なのか、それとも賃金上昇による企業改革の結果なのか。」
- 良い例: 「デフレ・需要不足下で、生産性向上だけを重視する政策は賃金上昇につながるのか。」

2. ai_answer:
- 「どちらも一理あります」で終わらせないでください。
- 景気局面を分けた暫定回答にしてください。
- ミクロ企業会計として正しい話と、マクロ経済政策として成立する話を分けてください。
- インフレ/デフレ、需要不足/需要超過、人手不足、失業率、労働需給を含めてください。
- この問いは景気局面を分けないと答えられない、と明示してください。
- ミクロ企業会計としては正しい主張でも、デフレ・需要不足下のマクロ政策として一般化すると危険になり得る点を示してください。
- 賃金上昇の起点として、需要増、労働需要増、人手不足、失業率低下、労働者の交渉力上昇を重視する見方を含めてください。
- ただし、人手不足による賃金上昇だけでは不十分で、需要拡大、価格転嫁、設備投資、労働移動が必要になる点も含めてください。

3. premises:
- 投稿者や登場人物が置いている前提をそのまま入れないでください。
- 判断に必要だが、投稿文だけでは不足している前提を入れてください。
- 悪い例: 「生産性が上がると賃金が上がる。」
- 悪い例: 「生産性が上がらない場合、価格に転嫁されると庶民が困る。」
- 悪い例: 「賃金が上がることで生産性を高める必要が生じる。」
- 良い例: 「現在がインフレ局面かデフレ局面かを確認する必要がある。」
- 良い例: 「需要不足か需要超過かによって、賃金上昇と生産性向上の関係は変わる。」
- 良い例: 「労働市場が人手不足か労働余剰かを確認する必要がある。」
- 良い例: 「失業率が低下圧力にあるか上昇圧力にあるかを確認する必要がある。」
- 良い例: 「企業が価格転嫁できる環境か、価格転嫁しても需要が落ちない環境かを確認する必要がある。」

4. reasons:
- 投稿者の感想や人物発言の補強ではなく、経済理論上の因果順序を入れてください。
- 悪い例: 「低賃金の状態では効率化のインセンティブが働かない。」
- 悪い例: 「賃金が上昇すれば、企業は競争力を維持するために生産性を向上させる。」
- 良い例: 「需要増により企業の売上期待が高まると、労働需要が増える。」
- 良い例: 「労働需要が増えると人手不足が起こり、失業率が低下しやすくなる。」
- 良い例: 「人手不足と失業率低下により、労働者の交渉力が上がり、賃金上昇圧力が生まれる。」
- 良い例: 「賃金上昇は企業に省力化、設備投資、業務改革を促す可能性がある。」
- 良い例: 「この流れはフィリップス曲線的に説明できる。」
- 良い例: 「生産性向上は賃金上昇の原因にも結果にもなり得るが、景気局面と需要環境によって意味が変わる。」

5. risks:
- 単なる人物同士の対立ではなく、主張が成立しない条件、逆効果になる条件、副作用を入れてください。
- デフレ・需要不足下の逆効果を必ず含めてください。
- 悪い例: 「賃金が上がると生産性が上がる。 / 生産性が上がらない場合は価格転嫁が起こり、庶民に負担がかかる。」
- 悪い例: 「低賃金の状態では効率化のインセンティブは働かない。 / 賃金が上がれば企業は必然的に生産性を向上させる。」
- 良い例: 「デフレ・需要不足下で生産性向上だけを進めると、省人化や人件費削減に使われ、労働需要が低下する可能性がある。」
- 良い例: 「労働需要が低下すると、失業率悪化、賃金停滞、所得減、消費低迷、デフレ圧力につながる可能性がある。」
- 良い例: 「賃金上昇があっても、需要拡大、価格転嫁、設備投資、労働移動が伴わなければ、企業収益悪化や実質賃金低下につながる可能性がある。」
- 良い例: 「価格転嫁を単純に悪と見ると、企業収益や賃金原資の確保という側面を見落とす可能性がある。」

禁止:
- 投稿者や登場人物の発言をそのまま premises / reasons / risks にコピーすること
- premises に「投稿文内の前提」をそのまま入れること
- reasons に人物発言の補強だけを入れること
- risks に両者の発言の対立をスラッシュ区切りで入れること
- 「竹中氏も一理ある、竹田氏も一理ある」だけで終わること
- 景気局面を確認せず一般論にすること
